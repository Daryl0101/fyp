...
from app_backend.lib.fast_rcnn.config import cfg
from app_backend.lib.fast_rcnn.bbox_transform import bbox_transform_inv, clip_boxes
from app_backend.lib.fast_rcnn.nms_wrapper import nms
...
def proposal_layer(
    ...
    bbox_deltas = (
        rpn_bbox_pred  # 模型输出的pred是相对值，需要进一步处理成真实图像中的坐标
    )
